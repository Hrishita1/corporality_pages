import "./creativityInnovation.css";
            ...
            <section>
                <div className="zommeffect">
                    <div className="zoom-text">
                        <h1 className="zoom-head" style={{backgroundImage: `url("/img/zoom-text/Rectangle\ 44.png")`}}>Creativity and Innovation are Limitless</h1>
